...
class user
{
    ...
    function updateJobByJobId($job_id, $org_name, $org_location, $job_title, $job_industry, $job_location, $job_type, $skills, $experience)
    {  
        $query = "UPDATE OJC_JOB SET ORG_NAME= '".$org_name."', ORG_LOCATION= '".$org_location."', JOB_TITLE= '".$job_title."', JOB_INDUSTRY= '".$job_industry."', JOB_LOCATION= '".$job_location."', JOB_TYPE= '".$job_type."', JOB_SKILLS= '".$skills."', JOB_EXPERIENCE= '".$experience."' WHERE JOB_ID = '".$job_id."'";      
    ...
    function deleteJob($job_id){
        $query = "DELETE FROM OJC_JOB WHERE JOB_ID = :job_id";        
        $stmt = $this->conn->prepare($query); 
        //Bind value.
        $stmt->bindParam(':job_id', $job_id);
    ...
    function updateProfileByUserId($user_id, $job_title, $job_industry, $job_location, $job_type, $skills, $experience)
    {  
        $query = "UPDATE OJC_JS_PROFILE SET JOB_TITLE= '".$job_title."', JOB_INDUSTRY= '".$job_industry."', JOB_LOCATION= '".$job_location."', JOB_TYPE= '".$job_type."', JOB_SKILLS= '".$skills."', JOB_EXPERIENCE= '".$experience."' WHERE USER_ID = '".$user_id."'";      
    ...
    function deleteProfile($user_id){
        $query = "DELETE FROM OJC_JS_PROFILE WHERE USER_ID = :user_id";        
        $stmt = $this->conn->prepare($query); 
        //Bind value.
        $stmt->bindParam(':user_id', $user_id);
    ...
    function insertJobOffer($user_id, $job_id, $subject)
    {   
        $last_id = NULL;
        $query = "INSERT INTO OJC_OFFER (USER_ID, JOB_ID, SUBJECT) VALUES (:user_id, :job_id, :subject)";
        $stmt = $this->conn->prepare($query); 
    ...
    function deleteJobOfferByJobID($job_id)
    { 
        $query = "DELETE FROM OJC_OFFER WHERE JOB_ID = :job_id";
        $stmt = $this->conn->prepare($query); 
    ...
    function deleteJobOfferByUserID($user_id)
    { 
        $query = "DELETE FROM OJC_OFFER WHERE USER_ID = :user_id";
        $stmt = $this->conn->prepare($query); 
